...
The following table contains the complete list of all RPC error codes returned by the Deribit API. Error codes are organized by their numeric ranges, with each code including a short message identifier and detailed description.
